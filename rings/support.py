...
class Support():
    ...
    To access the help page pf the command simply us `n!h [command]` and replace [command] with the command you seek to display, such as `n!h edain` will display the help page of the edain command. NecroBot is still WIP so take it easy.
    ...
    "ignored":
    "Displays the list of ignored channels and users.\n\n__Usage__\n`n!ignored`",
