...
class Support():
    ...
    async def about(self, ctx):
        ...
        embed.add_field(name="About", value="I'm currently in {} guilds and I can see {} members. I was created using Python and the d.py library. ".format(len(list(self.bot.guilds)), len(list(self.bot.get_all_members()))))
