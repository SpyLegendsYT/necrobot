        ...
        async def _phase_parser(event_name):
            ...
            while idle_tributes and len(tributes_list) > 1:
                ...
                try:
                    ...
                    embed.add_field(name='Error String', value=event["string"], inline=False)
                    embed.add_field(name='Error Tribute Number', value=event["tributes"], inline=False)
                    embed.add_field(name='Error Tribute Killed', value=event["killed"], inline=False)
                    embed.add_field(name='Error Tributes', value=str(format_dict), inline=False)
                    embed.set_footer(text="Generated by Necrobot", icon_url=self.bot.user.avatar_url_as(format="png", size=128))
