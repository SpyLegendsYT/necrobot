    ...
    async def edain(self, ctx, *, article : str):
        ...
        try:
            ...
            try:
                ...
                await ctx.send("Article: **{}** not found, returning first search result and the following search list: {}".format(article, search_list[1:]))
    ...
    async def lotr(self, ctx, *, article_name : str):
        ...
        if site.pages[article_name].text() != "":
            ...
            if len(search_list) > 0:
                await ctx.send("Article: **{}** not found, returning first search result and the following search list: {}".format(article_name, search_list))
    ...
    async def wiki(self, ctx, wiki : str, *, article_name : str):
        ...
        try:
            ...
            try:
                ...
                await ctx.send("Article: **{}** not found, returning first search result and the following search list: {}".format(article_name, search_list[1:]))
