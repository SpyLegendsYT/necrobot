...
class Hunger():
    ...
    async def fight(self, ctx, *, tributes):
        """Takes in a list of tributes seprated by `|` and simulates a hunger games based on Bransteele's Hunger Game Simulator. More than 
        ...
        if len(tributes_list) <2:
            await ctx.message.channel.send(":negative_squared_cross_mark: | Please provide at least two names")
            return
