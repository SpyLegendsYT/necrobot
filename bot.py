...
async def purge(cont, arg0 : int):
    ...
    if userData[cont.message.author.id]["perms"][cont.message.server.id] >= 7:
...
async def edain(cont,*,arg0 : str):
    ...
    try:
        ...
        embed.set_author(name=article.sub_wikia + " Wiki", url="http://edain.wikia.com/", icon_url="https://vignette3.wikia.nocookie.net/edain-mod/images/6/64/Favicon.ico")
...
async def lotr(cont,*,arg0 : str):
    ...
    try:
        ...
        embed.set_thumbnail(url=article.images[0]+"?size=400")
        embed.set_author(name="LOTR Wiki", url="http://lotr.wikia.com/", icon_url="https://vignette3.wikia.nocookie.net/lotr/images/6/64/Favicon.ico")
        embed.set_footer(text="Generated by NecroBot", icon_url="https://cdn.discordapp.com/avatars/317619283377258497/a491c1fb5395e699148fcfed2ee755cf.jpg?size=128")
